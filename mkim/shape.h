...
class shape {
   ...
   public:
      ...
      virtual void draw (const vertex&, const rgbcolor&, const bool&,\
         const GLfloat&, const string&, const size_t&) const = 0;
...
class text: public shape {
   ...
   public:
      ...
      virtual void draw (const vertex&, const rgbcolor&, const bool&,\
         const GLfloat&, const string&, const size_t&) const override;
...
//Calls ellipse constructor
//Circle just ellipse with height=width
